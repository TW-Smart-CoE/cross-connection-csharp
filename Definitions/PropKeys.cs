namespace CConn
{
    ...
    {
        public const string PROP_IP = "ip";
        public const string PROP_PORT = "port";
        public const string PROP_AUTO_RECONNECT = "auto_reconnect";
        public const string PROP_MIN_RECONNECT_RETRY_TIME = "min_reconnect_retry_time";
